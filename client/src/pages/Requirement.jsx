...
export default function Requirement() {
  ...
  const submit = async (e) => {
    ...
    try {
      ...
      const msg =
        ex?.response?.data?.error || ex?.message || "Extraction failed";
      setErr(msg);
    } finally {
      setBusy(false);
    }
  ...
  return (
    <div className="grid" style={{ marginTop: 18 }}>
      <div className="card card--soft">
        ...
        <div className="lead">
          Describe your requirement. We’ll extract entities, roles, features,
          and field schemas.
        </div>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            {result && (
              <button
                ...
                onClick={() =>
                  navigate("/generated", { state: { extracted: result } })
                }
              >
                Generate Mock UI
              </button>
      ...
      {result && (
        <div className="card">
          ...
          <div className="schema" style={{ marginTop: 8 }}>
            ...
            {schemas && (
              <div
                className="schema__row"
                style={{ gridTemplateColumns: "1fr" }}
              >
                <div className="schema__key" style={{ gridColumn: "1/-1" }}>
                  Entity Schemas
                </div>
